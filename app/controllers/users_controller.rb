class UsersController < ApplicationController
  before_action :logged_in_user, only: [:index, :edit, :update, :destroy, :following, :followers,:gotmsgs,:sentmsgs]
  before_action :correct_user,   only: [:edit,:update,:gotmsgs,:sentmsgs]
